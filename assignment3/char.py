...
from char_utilities import plot_radar_residuals, plot_mag_residuals, split_segments, MeasurementData, print_estimation_results
...
if __name__ == "__main__":
    ...
    # print(first_filter_output[list(first_filter_output.keys())[0]]["state"])
    ...
    # plot_radar_residuals(times*60, residuals_array, True)
    # plt.show()
    ...
    plot_mag_residuals(time_hours, residuals)
    ...
    plot_radar_residuals(times*60, residuals_array)
    plt.show()
    ...
    #         print_estimation_results(state_params)
    #         break

    
    # # Plotting
    # plot_radar_residuals(final_residuals["radar_resid_tk"], final_residuals["radar_resid"], title=True)
    ...
    # # Post-fit residuals
    # plot_mag_residuals(time_hours, residuals, True)
